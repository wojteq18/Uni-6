...
fn main() {
    ...
    println!("Uruchamiam Local Search {} razy...", num_runs);
    ...
    for run in 0..num_runs {
        ...
        println!("Przejście {}: Dystans = {}, Kroki poprawy = {}", run + 1, final_dist, iteration);
